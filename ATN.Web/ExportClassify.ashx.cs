...
namespace ATN.Web
{
    ...
    /// </summary>
    public class ExportClassify : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (Int32.TryParse(context.Request["TheoryId"], out TheoryId))
            {
                ...
                ExtendedSource[] TrainSources = t.GetClassifySourcesForTheory(TheoryId).ToArray();
                ...
                context.Response.AddHeader("Content-Disposition", "attachment; filename=" + TheoryId + "-classify.arff");
